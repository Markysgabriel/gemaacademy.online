    ...
    [354],
    {
        ...
        7323: (e, t, n) => {
            ...
            class NestedTabs extends r.default {
                ...
                getDefaultElements() {
                    const e = this.getSettings("selectors");
                    return { $wdigetContainer: this.findElement(e.widgetContainer), $tabTitles: this.findElement(e.tabTitle), $tabContents: this.findElement(e.tabContent), $headingContainer: this.findElement(e.headingContainer) };
                }
                ...
                activateDefaultTab() {
                    ...
                    this.setSettings({ showTabFn: "show", hideTabFn: "hide" }), this.changeActiveTab(t), this.setSettings(n), this.elements.$wdigetContainer.addClass("e-activated");
                }
